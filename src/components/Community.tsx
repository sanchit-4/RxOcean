    ...
    <section className="py-16 px-4 md:px-6 bg-gradient-to-br from-blue-50 to-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <img src="https://images.unsplash.com/photo-1551966775-a4ddc8df052b?auto=format&fit=crop&q=80" alt="Community Initiatives" className="w-full h-full object-cover rounded-xl mb-2" />
          </motion.div>
